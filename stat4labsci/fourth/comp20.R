...
# Lecture 20                                 Johns Hopkins University 
######################################################################
...
##############################
# The data:
#     http://www.biostat.jhsph.edu/~kbroman/teaching/labstat/fourth/puromycin.csv
...
# The non-linear fit; need the library "nls"
library(nls)
...
##############################
# The data:
#     http://www.biostat.jhsph.edu/~kbroman/teaching/labstat/fourth/chlorine.csv  
cl <- read.csv("chlorine.csv")
