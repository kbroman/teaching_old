...
x5 <- matrix(sammix(9 000*5,m,s,p),ncol=5)
x9  <- matrix(sammix(9 000*9 ,m,s,p),ncol=9 )
x25 <- matrix(sammix(9 000*25,m,s,p),ncol=25)
x9 0 <- matrix(sammix(9 000*9 0,m,s,p),ncol=9 0)
